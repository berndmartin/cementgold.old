...
/*=====================================
=            Minify images            =    ######################## bma changed !!!!!!!!!!!!!!!
=====================================*/

gulp.task('images', function () {
  var stream = gulp.src('src/images/**/*')
  
  if (config.minify_images && false) {
...
gulp.task('html', function() {
  var inject = [];
  if (typeof config.weinre === 'object' && false) {
...
gulp.task('js', function() {
    streamqueue({ objectMode: true },
      ...
      gulp.src(['src/templates/**/*.html']).pipe(templateCache({ module: 'YieldEstateApp' }))
    )
