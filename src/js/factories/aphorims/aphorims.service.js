(function () {
    ...
    angular
       .module('YieldEstateApp.Factories.EstateAphorims')
       .factory('EstateAphorims', EstateAphorims);

    EstateAphorims.$inject = ['log','EstateTranslateService'];

    function EstateAphorims (log,EstateTranslateService) {
