...
angular.module('YieldEstateApp.Directive.EstateCalc',[])
.directive('estateCalc', function (log,$window,$filter) {  
  var srv     = {};
  srv.id      = 0;
  srv.rest    = 0;
  srv.zins    = 0;
  ...
  return {
    link: function (scope, element, attrs) {
      scope.$watchCollection('estate', function(newNames,oldNames) {
